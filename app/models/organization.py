...
class Workspace(
    ...
    timezone: Mapped[str] = mapped_column(
        String(50), nullable=False, default="Asia/Riyadh", server_default="Asia/Riyadh"
    )
    status: Mapped[WorkspaceStatus] = mapped_column(
        SAEnum(WorkspaceStatus, name="workspace_status"), nullable=False, default=WorkspaceStatus.active, server_default="active"
    )
...
class User(
    ...
    status: Mapped[UserStatus] = mapped_column(
        SAEnum(UserStatus, name="user_status"), nullable=False, default=UserStatus.active, server_default="active"
    )
...
class WorkspaceMember(
    ...
    status: Mapped[MembershipStatus] = mapped_column(
        SAEnum(MembershipStatus, name="membership_status"), nullable=False, default=MembershipStatus.active, server_default="active"
    )
...
class Role(
    ...
    scope: Mapped[RoleScope] = mapped_column(
        SAEnum(RoleScope, name="role_scope"), nullable=False, default=RoleScope.workspace, server_default="workspace"
    )
...
class WorkspaceMemberRole(
    ...
    __table_args__ = (
        ...
        UniqueConstraint(
            "workspace_member_id",
            "role_id",
            name="uq_workspace_member_roles_member_role",
        ),
