...
class BrandPlatformProfile(
    ...
    tone: Mapped[str | None] = mapped_column(String(150), nullable=True)
...
class PlatformAccount(
    ...
    credentials_reference: Mapped[str | None] = mapped_column(String(500), nullable=True)
    status: Mapped[PlatformAccountStatus] = mapped_column(
        SAEnum(PlatformAccountStatus, name="platform_account_status"),
        nullable=False,
