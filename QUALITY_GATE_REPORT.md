# Sprint Release 0.6.1 — Quality Gate Report
...
- Added application release version `0.6.1` to API metadata and health output.
...
- Read-only Alembic state inspection added.
- Missing migration state and up-to-date state covered by automated tests.
- Full test suite passed locally: 24 tests.
